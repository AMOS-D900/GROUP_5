...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO applicants (full_name, email, phone, olevel_results, jamb_score, course_choice, birth_certificate, lga_certificate, passport_photo, payment_receipt)
            VALUES ('$full_name', '$email', '$phone', '$olevel_results', '$jamb_score', '$course_choice', '$birth_certificate', '$lga_certificate', '$passport_photo', '$payment_receipt')";
